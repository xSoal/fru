...
<section class="users_list main_section ">
    ...
    <div class="search_block">
        <div class="search_form">
            <form action="{{ route('admin.postUsers') }}" method="POST" class="for_search">
				{{ csrf_field() }}
        ...
        <div class="add_new_item">
            <a href="{{ route('admin.addUser') }}" class="add_item">Добавить</a>
        </div>
			    ...
			    @foreach($items as  $k => $item)
                    <div class="tr_block" data-id="{{ $item->id }}" data-type="user">
                        <div class="tr tr_values">
                            ...
                            <div class="td edit">
                                <a href="{{ route('admin.viewUser', ['id' => $item->id]) }}" class="edit_link">
                                    <span>
