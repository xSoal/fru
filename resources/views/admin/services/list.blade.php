...
<section class="users_list main_section active">
    <div class="title_h1">
        <h1>Список Dealers and Service</h1>
    </div>
    <div class="search_block">
        <div class="search_form">
            <form action="{{ route('admin.postService') }}" method="POST" class="for_search">
				{{ csrf_field() }}
        ...
        <div class="add_new_item">
            <a href="{{ route('admin.addService') }}" class="add_item">Додати</a>
        </div>
			    ...
			    @foreach($items as  $k => $item)
                    <div class="tr_block" data-id="{{ $item->id }}" data-type="user">
                        <div class="tr tr_values">
                            ...
                            <div class="td edit">
                                <a href="{{ route('admin.viewService', ['id' => $item->id]) }}" class="edit_link">
                                    <span>
