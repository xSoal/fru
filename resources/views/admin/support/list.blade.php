...
<section class="product_type main_section">
    ...
    <div class="search_block">
        <div class="search_form">
            <form action="{{ route('admin.support') }}" method="GET" class="for_search">
				{{-- {{ csrf_field() }} --}}
        ...
        <div class="add_new_item">
            <a href="{{ route('admin.add_support') }}" class="add_item">Додати</a>
        </div>
			    ...
			    @foreach($items as  $k => $item)
                    <tr class="tr_block" data-id="{{ $item->id }}" data-type="news">
                        <div class="">
                            ...
                            <td class="edit">
                                <a href="{{ route('admin.view_support', ['id' => $item->id]) }}" class="edit_link">
                                    <span>
