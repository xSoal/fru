...
! function(e, a, r) {
    ...
    jQuery(document).ready(function() {
        ...
        if ("" != r)
            ...
            } else e.inArray(u, ext_img) > -1 ? (f = f + "?" + (new Date).getTime(), c = '<img src="' + f + '" alt="' + o + '" />') : e.inArray(u, d) > -1 ? c = '<video controls source src="' + f + '" type="video/' + u + '">' + o + "</video>" : e.inArray(u, s) > -1 ? ("mp3" == u && (u = "mpeg"), c = '<audio controls src="' + f + '" type="audio/' + u + '">' + o + "</audio>") : e.inArray(u, iframe) > -1 ? c = '<iframe src="' + f + '" >' + o + "</iframe>" : c = '<a href="' + f + '" title="' + o + '">' + o + "</a>", 1 == jQuery("#crossdomain").val() ? t.postMessage({
            sender: "responsivefilemanager",
            url: f,
            field_id: null,
            html: c
