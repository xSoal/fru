	...
	_injectTimePicker: function() {
		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			...
			if (o.showHour && o.hourGrid > 0) {
				html += '<div style="padding-left: 1px"><table class="ui-tpicker-grid-label" cellspacing="0" cellpadding="0"><tr>';
			...
			if (o.showSecond && o.secondGrid > 0) {
				html += '<div style="padding-left: 1px"><table cellspacing="0" cellpadding="0"><tr>';
